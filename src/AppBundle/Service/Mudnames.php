 ...
 * @version 1.4
 * @url https://github.com/xrogaan/phpMudnames
 */
...
class Mudnames_Dictionnaries {
     ...
     */
    public function __construct($directory=__DIR__.'/data/') {
...
class Mudnames_Dictionnary {
    ...
    /**
     * D?tecte si un fichier doit avoir une g?n?ration statique de noms.
     */
    ...
    /**
     * S?lectionne une association de capacit? de fa?ons al?atoire et la retourne.
     */
    ...
    /**
     * Sors une partie de nom al?atoire selon le tag et le fichier associ?.
     */
    ...
    /**
     * retourne la liste des parties pr?sente dans le fichier dictionnaire
     *
     * @return array
     */
